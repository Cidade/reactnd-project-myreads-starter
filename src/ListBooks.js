...
function ListBooks (props) {
    ...
    const onSelectChange = (e, book) => {

        e.preventDefault();

        if (props.onSelectChangeBook)
            props.onSelectChangeBook(e.target.value, book);
    }

    let { lstBooks, title } = props;
                            ...
                            <div className="book">
                                <div className="book-top">
                                    ...
                                    <div className="book-shelf-changer">
                                        <select name='sltBook' value={book.shelf} onChange={(event) => onSelectChange(event, book)}>
